    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <form id="form" onsubmit="return;">
          ...
          <div class="form-group">
            <label>密码</label>
            <input type="password" id="password" name="password" value="" class="form-control" placeholder="密码(为空不修改)"/>
          </div>
          <div class="form-group">
            <label>积分</label>
            <input type="number" pattern="\d" id="score" name="score" value="${user.score!0}" class="form-control"
                   placeholder="积分"/>
          </div>
          <div class="form-group">
            <label>邮箱</label>
          ...
          <div class="form-group">
            ...
            <input type="text" id="githubName" name="githubName" value="${user.githubName!}" class="form-control"
                   placeholder="githubName"/>
          </div>
          <div class="form-group">
            <label>telegramName</label>
            <input type="text" id="telegramName" name="telegramName" value="${user.telegramName!}" class="form-control"
